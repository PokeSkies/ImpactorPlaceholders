...
class BalanceFormatted : PlayerPlaceholder {
    override fun handle(player: ServerPlayer, args: List<String>): GenericResult {
        ...
        return GenericResult.valid(ImpactorUtils.formatBigDecimal(ImpactorUtils.balance(player, currency), decimals))
    }

    override fun ids(): List<String> = listOf("balance_formatted")
}
